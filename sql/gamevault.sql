...
CREATE TABLE permissoes_usuario (
  ...
  manage_content TINYINT(1) NOT NULL DEFAULT 0,
  manage_categories TINYINT(1) NOT NULL DEFAULT 0,
  view_logs TINYINT(1) NOT NULL DEFAULT 0,
  atualizado_em DATETIME NULL,
  UNIQUE KEY uq_permissoes_usuario (usuario_id),
...
('admin', 'admin@gamevault.local', '$2y$12$2fenhiSeh1kiJAgUSqen5uti0EWX8Ga7tdtspXGhQMT52TbGyM.0y', 'admin', 'ativo', NOW()),
...
INSERT INTO permissoes_usuario (usuario_id, manage_users, manage_content, manage_categories, view_logs, atualizado_em) VALUES
(1, 1, 1, 1, 1, NOW()),
(2, 0, 0, 0, 0, NOW());
